    ...
    <section className="relative min-h-[85vh] flex items-center overflow-hidden">
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-36">
        <div className="max-w-3xl animate-fade-in">
          <div className="inline-flex items-center gap-2 bg-blue-500/20 border border-blue-400/30 backdrop-blur-sm rounded-full px-4 py-1.5 text-sm text-blue-200 mb-8">
            <Shield className="h-4 w-4" />
            Trusted Logistics Partner Since 2000
          </div>
          <h1 className="text-4xl md:text-7xl font-bold leading-tight mb-6 text-balance">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              to="/services"
              className="group inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-400 text-white px-8 py-3.5 rounded-xl font-semibold transition shadow-lg shadow-blue-500/25 hover:shadow-blue-400/40"
            >
              Our Services <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition" />
            </Link>
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 border border-white/30 hover:bg-white/10 text-white px-8 py-3.5 rounded-xl font-semibold transition backdrop-blur-sm"
            >
              Get a Quote
            </Link>
          </div>
